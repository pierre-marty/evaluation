...
<head>
  ...
  <title>Eco'dom - Le Spécialiste des énergies renouvelables</title>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/alternative-21581_1920.jpg" class="d-block w-100" alt="panneau_solaire">
      </div>
      <div class="carousel-item">
        <img src="img/alternative-21761_1920.jpg" class="d-block w-100" alt="panneau_solaire">
      </div>
      <div class="carousel-item">
        <img src="img/windmill-62257_1920.jpg" class="d-block w-100" alt="éolienne">
      </div>
    </div>
    ...
    <h1 class="text-center mb-4">Bienvenue sur Eco'Dom</h1>
    <h2 class="text-center mb-4">Le spécialiste des énergies renouvelables</h2>
...
$reponse = $bdd->query('SELECT * FROM offres ORDER BY RAND() LIMIT 0,3');
...
<table class="table table-striped m-auto w-50">
  <tbody>
    <tr>
      <td class="col-4"><a href="contact.php"><?php echo $donnees['designation']?></a></td>
